    ...
    <div className={`xl:hidden flex flex-col trans dark:shadow-inner bg-white shadow-lg   w-2/5 z-50 top-24 absolute ${menu? "right-0":"right-full"} rounded-l-lg`}>
        <div className='mt-4'>
            ...
            <div className='flex flex-col items-center justify-between  mt-4 gap-3 text-[#667085]'>
                <div className='flex justify-start gap-3 items-center cursor-pointer w-full text-base  dark:bg-gray-300 hover:bg-blue-600 hover:text-white px-3 py-2'>
                <AiOutlineSetting size={25}/>
                <p>Settings</p>
                </div>
                <div className='flex justify-start gap-3 items-center mb-2 cursor-pointer w-full text-base  dark:bg-gray-300 hover:bg-blue-600 hover:text-white px-3 py-2'>
