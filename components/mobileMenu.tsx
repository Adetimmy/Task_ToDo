  ...
  return (
    <div className={`xl:hidden flex flex-col trans dark:shadow-inner bg-white shadow-lg   w-2/5 z-50 top-24 absolute ${menu? "right-0":"right-full"} rounded-l-lg`}>
        <div className='mt-4'>
            ...
            <div className='flex flex-col items-center justify-between  mt-4 gap-[2px] text-[#667085]'>
                ...
                <div className='flex justify-start gap-1 items-center mb-4 cursor-pointer w-full text-sm  dark:bg-gray-300 hover:bg-blue-600 hover:text-white px-3 py-2'>
