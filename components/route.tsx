...
export default function Home() {
  ...
  return (
   ...
   {/*this salutation handles the greeting and the floating date  */}
      ...
      <div className='fixed bottom-0 md:w-4/6 md:px-14 w-full px-4 min-h-[45px]'><Input/></div>
    </div>
   <div className='absolute bottom-0 left-0 h-4/6 w-full md:hidden'>{field.show && <Frame />}</div> 
   </main>
  )
}
